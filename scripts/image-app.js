(function(){
  ...
  function manipulateImage(type) {
    ...
    worker.postMessage({type: type, imageData: imageData});// Hint! This is where you should post messages to the web worker and
    worker.onmessage = function(e) {
      ...
      if (imageData) {
        ...
        console.log("Transformed image was not returned");
      }
    };
  };
